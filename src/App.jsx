    ...
    <>
      ...
      {showContent && (
        <div className="main w-full rotate-[-10deg] scale-[1.7]">
          ...
          {/* Connect Section */}
          <div className="w-full bg-gradient-to-b from-black via-gray-900 to-black py-12">
            <div className="container mx-auto px-10 max-w-4xl">
              <div className="text-center mb-8">
                <span className="text-yellow-500 text-sm font-semibold tracking-wider uppercase">Network</span>
              ...
              <div className="flex justify-center gap-6 mb-8">
                ...
                <a 
                  href="#" 
                  className="group bg-gray-900 border border-gray-700 hover:border-blue-500 transition-all duration-300 p-4 transform hover:scale-105"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-blue-600 group-hover:bg-blue-500 transition-colors duration-300 rounded flex items-center justify-center">
                ...
                <a 
                  href="#" 
                  className="group bg-gray-900 border border-gray-700 hover:border-gray-500 transition-all duration-300 p-4 transform hover:scale-105"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-gray-700 group-hover:bg-gray-600 transition-colors duration-300 rounded flex items-center justify-center">
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-white font-semibold group-hover:text-gray-400 transition-colors">GitHub</span>
                  </div>
                </a>
                ...
                <a 
                  href="#" 
                  className="group bg-gray-900 border border-gray-700 hover:border-purple-500 transition-all duration-300 p-4 transform hover:scale-105"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-purple-600 group-hover:bg-purple-500 transition-colors duration-300 rounded flex items-center justify-center">
                      <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                      </svg>
                    </div>
                    <span className="text-white font-semibold group-hover:text-purple-400 transition-colors">Portfolio</span>
                  </div>
                </a>
              </div>
              ...
              <div className="text-center">
                <button className="bg-yellow-500 hover:bg-yellow-400 transition-all duration-300 px-8 py-3 text-black font-bold text-sm tracking-wider transform hover:scale-105">
                  GET IN TOUCH
                </button>
              </div>
            </div>
