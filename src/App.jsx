      ...
      {showContent && (
        <div className="main w-full rotate-[-10deg] scale-[1.7]">
          ...
          <div className="w-full min-h-screen bg-gradient-to-b from-black to-gray-900 py-20">
            <div className="container mx-auto px-10 max-w-6xl">
              <div className="text-center mb-20">
                <span className="text-yellow-500 text-lg font-semibold tracking-wider">CONNECT WITH ME</span>
                <h2 className="text-white text-5xl font-black mt-4">
                  PORTFOLIO
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="group">
                  <a 
                    href="#" 
                    className="block bg-gray-800 hover:bg-gray-700 transition-all duration-300 p-8 text-center border-2 border-transparent hover:border-yellow-500 transform hover:scale-105"
                  >
                    <div className="mb-6">
                      <svg className="w-16 h-16 mx-auto text-blue-500 group-hover:text-yellow-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                      </svg>
                    </div>
                    <h3 className="text-white text-xl font-bold mb-2 group-hover:text-yellow-500 transition-colors">LinkedIn</h3>
                    <p className="text-gray-400 group-hover:text-gray-300 transition-colors">Professional Network</p>
                  </a>
                </div>
                ...
                <div className="group">
                  ...
                  >
                    <div className="mb-6">
                      <svg className="w-16 h-16 mx-auto text-gray-300 group-hover:text-yellow-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 className="text-white text-xl font-bold mb-2 group-hover:text-yellow-500 transition-colors">GitHub</h3>
                    <p className="text-gray-400 group-hover:text-gray-300 transition-colors">Code Repository</p>
                  </a>
                </div>
                ...
                <div className="group">
                  ...
                  >
                    <div className="mb-6">
                      <svg className="w-16 h-16 mx-auto text-purple-500 group-hover:text-yellow-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 0L1 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-11-5z"/>
                      </svg>
                    </div>
                    <h3 className="text-white text-xl font-bold mb-2 group-hover:text-yellow-500 transition-colors">Portfolio</h3>
                    <p className="text-gray-400 group-hover:text-gray-300 transition-colors">Personal Website</p>
                  </a>
                </div>
                ...
                <div className="group">
                  ...
                  >
                    <div className="mb-6">
                      <svg className="w-16 h-16 mx-auto text-green-500 group-hover:text-yellow-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 className="text-white text-xl font-bold mb-2 group-hover:text-yellow-500 transition-colors">GeeksforGeeks</h3>
                    <p className="text-gray-400 group-hover:text-gray-300 transition-colors">Coding Profile</p>
                  </a>
                </div>
              </div>
              ...
              <div className="text-center mt-16">
                ...
                <button className="mt-6 bg-yellow-500 hover:bg-yellow-400 transition-colors px-8 py-4 text-black font-bold text-xl tracking-wider shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform">
                  GET IN TOUCH
                </button>
              </div>
            </div>
