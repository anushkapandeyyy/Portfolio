    ...
    <>
      ...
      {showContent && (
        <div className="main w-full rotate-[-10deg] scale-[1.7]">
          ...
          {/* Contact Me Section */}
          <div className="w-full bg-gradient-to-b from-black via-gray-900 to-black py-20">
            <div className="container mx-auto px-10 max-w-4xl">
              <div className="text-center mb-12">
                <span className="text-yellow-500 text-lg font-semibold tracking-wider uppercase">Get In Touch</span>
                <h2 className="text-white text-5xl font-black mt-4">
                  CONTACT ME
                </h2>
              ...
              {/* Contact Form */}
              <div className="bg-gray-900 border border-gray-700 p-8 mb-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    <label className="block text-yellow-500 text-sm font-semibold mb-2">NAME</label>
                    <input 
                      type="text" 
                      className="w-full bg-black border border-gray-600 text-white px-4 py-3 focus:border-yellow-500 focus:outline-none transition-colors"
                      placeholder="Your name"
                    />
                  </div>
                  <div>
                    <label className="block text-yellow-500 text-sm font-semibold mb-2">EMAIL</label>
                    <input 
                      type="email" 
                      className="w-full bg-black border border-gray-600 text-white px-4 py-3 focus:border-yellow-500 focus:outline-none transition-colors"
                ...
                <div className="mb-6">
                  <label className="block text-yellow-500 text-sm font-semibold mb-2">MESSAGE</label>
                  <textarea 
                    rows="5"
                    className="w-full bg-black border border-gray-600 text-white px-4 py-3 focus:border-yellow-500 focus:outline-none transition-colors resize-none"
                    placeholder="Tell me about your project..."
                  ></textarea>
                </div>
                <div className="text-center">
                  <button className="bg-yellow-500 hover:bg-yellow-400 transition-all duration-300 px-8 py-3 text-black font-bold text-lg tracking-wider transform hover:scale-105">
                    SEND MESSAGE
                  </button>
                </div>
              </div>
              ...
              {/* Social Links */}
              <div className="text-center">
                <p className="text-gray-400 text-sm mb-4">Or connect with me on social media</p>
                <div className="flex justify-center gap-4">
                  ...
                  >
                    <div className="w-5 h-5 bg-blue-600 group-hover:bg-blue-500 transition-colors duration-300 rounded-full flex items-center justify-center">
                  ...
                  <a 
                    ...
                    className="group transition-all duration-300 transform hover:scale-110"
                  >
                    <div className="w-5 h-5 bg-gray-700 group-hover:bg-gray-600 transition-colors duration-300 rounded-full flex items-center justify-center">
                      <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    className="group transition-all duration-300 transform hover:scale-110"
                  >
                    <div className="w-5 h-5 bg-blue-400 group-hover:bg-blue-300 transition-colors duration-300 rounded-full flex items-center justify-center">
                      <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    className="group transition-all duration-300 transform hover:scale-110"
                  >
                    <div className="w-5 h-5 bg-gradient-to-br from-purple-600 to-pink-500 group-hover:from-purple-500 group-hover:to-pink-400 transition-all duration-300 rounded-full flex items-center justify-center">
                      <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a 
                    ...
                    className="group transition-all duration-300 transform hover:scale-110"
                  >
                    <div className="w-5 h-5 bg-red-600 group-hover:bg-red-500 transition-colors duration-300 rounded-full flex items-center justify-center">
                      <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
