          ...
          <div className="w-full bg-gradient-to-b from-black to-gray-900 py-16">
            <div className="container mx-auto px-10 max-w-4xl">
              <div className="text-center mb-12">
                <span className="text-yellow-500 text-sm font-semibold tracking-wider">CONNECT</span>
              ...
              <div className="flex flex-wrap justify-center gap-6">
                ...
                <a 
                  href="#" 
                  className="group flex items-center gap-3 bg-gray-800 hover:bg-gray-700 transition-all duration-300 px-6 py-3 border border-gray-700 hover:border-yellow-500"
                >
                  <svg className="w-5 h-5 text-blue-500 group-hover:text-yellow-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                  <span className="text-white text-sm font-semibold group-hover:text-yellow-500 transition-colors">LinkedIn</span>
                </a>
                ...
                <a 
                  ...
                  className="group flex items-center gap-3 bg-gray-800 hover:bg-gray-700 transition-all duration-300 px-6 py-3 border border-gray-700 hover:border-yellow-500"
                >
                  <svg className="w-5 h-5 text-gray-300 group-hover:text-yellow-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-white text-sm font-semibold group-hover:text-yellow-500 transition-colors">GitHub</span>
                </a>
                ...
                <a 
                  ...
                  className="group flex items-center gap-3 bg-gray-800 hover:bg-gray-700 transition-all duration-300 px-6 py-3 border border-gray-700 hover:border-yellow-500"
                >
                  <svg className="w-5 h-5 text-purple-500 group-hover:text-yellow-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H6.9C4.29 7 2.2 9.12 2.2 11.8v.4C2.2 14.88 4.29 17 6.9 17h4v-1.9H6.9c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9.1-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.61 0 4.7-2.12 4.7-4.8v-.4C21.8 9.12 19.71 7 17.1 7z"/>
                  </svg>
                  <span className="text-white text-sm font-semibold group-hover:text-yellow-500 transition-colors">Portfolio</span>
                </a>
                ...
                <a 
                  ...
                  className="group flex items-center gap-3 bg-gray-800 hover:bg-gray-700 transition-all duration-300 px-6 py-3 border border-gray-700 hover:border-yellow-500"
                >
                  <svg className="w-5 h-5 text-green-500 group-hover:text-yellow-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-white text-sm font-semibold group-hover:text-yellow-500 transition-colors">GeeksforGeeks</span>
                </a>
              </div>

              <div className="text-center mt-8">
                <button className="bg-yellow-500 hover:bg-yellow-400 transition-colors px-6 py-2 text-black font-bold text-sm tracking-wider">
                  GET IN TOUCH
                </button>
              </div>
            </div>
